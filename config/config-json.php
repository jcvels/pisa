...
if ( $DB_HOST != null || $DB_NAME != null || $DB_USER != null || $DB_PASS != null || $APP_CUST  != null || $APP_LOGO  != null )
{
        $arr_clientes = array('DB_HOST'=>$DB_HOST, 'DB_NAME'=>$DB_NAME,'DB_USER'=>$DB_USER,'DB_PASS'=>$DB_PASS,'APP_CUST'=>$APP_CUST,'APP_LOGO'=>$APP_LOGO);
